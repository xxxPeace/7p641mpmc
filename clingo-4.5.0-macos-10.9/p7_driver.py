...
if __name__ == '__main__':
    clingo = subprocess.Popen(
        "/Users/peace/Desktop/clingo-4.5.0-macos-10.9/gringo level-core.lp level-style.lp level-sim.lp level-shortcuts.lp |/Users/peace/Desktop/clingo-4.5.0-macos-10.9/reify |/Users/peace/Desktop/clingo-4.5.0-macos-10.9/clingo - meta.lp metaD.lp metaO.lp metaS.lp --parallel-mode=4 --outf=2",
        shell = True, stdout=subprocess.PIPE,stderr=subprocess.PIPE)
    out, err = clingo.communicate()
    if err:
        print err
        design = parse_json_result(out)
